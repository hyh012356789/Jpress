 ...
 */
public class ShoppingModuleGenerator {
    ...
    private static String moduleName = "shopping";
    private static String dbTables = "single_shopping";
    private static String modelPackage = "io.jpress.module.shopping.model";
    private static String servicePackage = "io.jpress.module.shopping.service";
